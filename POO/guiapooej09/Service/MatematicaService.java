...
*/
package guiapooej09.Service;

import guiapooej09.Entidades.Matematica;
...
public class MatematicaService {
   ...
   public void crearNum(){
    //math.setNum1((float) Math.random()*10);
    //math.setNum2((float) Math.random()*10);
   ...
   public void  devolverMayor(){
        if (math.getNum1()>math.getNum2()) {
           System.out.println(" el numero mayor es " + math.getNum1()+ " y  el numero menor es " + math.getNum2());
           calcularPotencia(math.getNum1(),math.getNum2());
           calculaRaiz(math.getNum2());
       }else{  System.out.println(" el numero mayor es " + math.getNum2()+ " y  el numero menor es " + math.getNum1());
